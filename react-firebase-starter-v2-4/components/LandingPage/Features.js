...
const features = [
  ...
  },
  {
    name: "Firebase",
    description:
      "Providing well-built, documented and scalable solutions from database, file storage, global CDN hosting, authentication to serverless backends. Everything you need to provide a rich, secure app that scales to millions of users.",
    image: (
