...
const stepsBasicSetup = [
  ...
  {
    name: "Enable the Email/Password Sign-in provider in the Authentication tab in the Firebase Console",
    subSteps: [
      {
        subStep: (
          <span>
  ...
  {
    name: "Enable the FireStore API in the Firebase Console",
    subSteps: [
      {
        subStep: (
          <span>
            ...
            and click on the <span className="italic">Firestore</span> tab.
          </span>
        ),
      },
      {
      ...
      },
      {
        subStep: (
          <span>
            ...
            Firestore database. It is best to choose the same region you did
            choose for the creation of the Firebase project.
          </span>
        ),
      },
    ],
        ...
        <div key={gettingStartedStep.header}>
          ...
          >
            ...
            {gettingStartedStep.advancedFunctionality && (
              <span className="bg-lightning-100 text-lightning-600 inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium">
