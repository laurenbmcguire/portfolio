          ...
          <Popover>
            <div className="relative pt-6 pl-4 sm:pl-6 lg:pl-8">
              ...
              >
                  ...
                  <div className="flex w-full items-center justify-between md:w-auto">
                    <a href="#" aria-label="Home" className="flex items-center">
                      ...
                      <div className="leading-5">
                        ...
                        <span className="block xl:inline">Text Extractor</span>
                      </div>
                    </a>
                ...
                <div className="hidden md:ml-10 md:block md:space-x-6 md:pr-4">
                  {navigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                  ...
                  <div className="flex items-center justify-between px-5 pt-4">
                    <div>
                      ...
                      <div className="leading-5">
                        ...
                        <span className="block xl:inline">Text-Hacker</span>
                      </div>
                    </div>
                    <div className="-mr-2">
                      <Popover.Button className="inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-lightning-500">
          ...
          <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="max-w-lg text-4xl font-extrabold tracking-tight text-gray-900 sm:mx-auto sm:text-5xl md:text-6xl lg:mx-0">
                Convert your scanned files into searchable, easy to format text FAST!
              </h1>
              <p className="mt-3 text-base text-gray-600 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0">
                Utilize the power of OCR to improve your workflow and go paperless!
              </p>
              ...
              <div className="mb-2 mt-7 sm:mb-0 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <div className="group relative rounded-xl shadow">
                  <Link href={"#pricing"}>
                    ...
                    >
                      Save hours each week by getting started now!
                    </a>
                  </Link>
                </div>
              </div>
              <div className="mx-auto max-w-md p-2 text-gray-500 sm:mt-3 sm:p-0 lg:mx-0">
                <Link href="https://texthacker.gumroad.com/l/tcqjx">
                  <a
                    className=""
                    onClick={() =>
                      collectAnalyticsEvent({
