...
const features = [
  {
    ...
    description:
      "Upload unlimited files and convert them to text in an instant.",
    image: <img src="/nextjs-32x32.png" alt="" />,
  },
  {
    name: "Improved workflow",
    description:
      "Save hours of time of manual data entry and focus on other tasks" ,
    image: (
      <img
        src="data:image/svg+xml;base64,"
        alt=""
        className="translate-y-0.5 transform"
      />
    ),
  },
  {
    name: "A fraction of the cost of most OCR options on the market",
    description: "for only $9.99 per month your small business can save money with Text-Hacker",
    image: (
  ...
  {
    name: "Secured with authentication so your documents stay private!",
    description:
      "Easy log in and sign up with Google or email address/phone number",
    image: (
      <svg
        viewBox="0 0 248 31"
        className="h-4 w-auto translate-y-1 -translate-x-px transform"
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
  ...
  },
  {
    ...
    description:
      "Pay with debit or credit card with our secure stripe integration",
    image: (
      <svg
        viewBox="0 0 60 25"
  ...
  },
  {
    ...
    description:
      "We are so confident you will love Text-Hacker we have a money back guarantee, give us a try to see how Text-Hacker can work for you!",
    image: (
      <svg
        fill="none"
        height="30"
  ...
  },
  {
    ...
    description:
      "We are happy to help answer any questions you may have and are always working on new features to improve so drop us a message in chat with questions/suggestions",
    icon: DocumentTextIcon,
  },
  {
    name: "Save the planet",
    description:
      "By scanning in your old paperwork and moving to a paperless work-flow you are helping to save our tress and reducing your carbon footprint",
    icon: KeyIcon,
  },
];
...
export default function Features() {
  return (
    <div className="bg-lightning-200 py-12" id="features">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          <h2 className="text-base font-semibold uppercase tracking-wide text-lightning-600">
            React SaaS Template
          </h2>
          ...
          <p className="mt-4 max-w-2xl text-xl text-gray-700 lg:mx-auto">
           Spending hours and hours on manual data entry is not fun, let Text-Hacker help
            you digitize your scanned documents into searchable text fast without needing
            to outsource and save valuable time and resources for your organization.
          </p>
        </div>

        <div className="mt-10">
          <dl className="space-y-10 px-4 sm:px-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10 md:space-y-0">
            {features.map((feature) => (
              <div key={feature.name} className="relative">
                <dt>
                  <div className="absolute flex h-12 w-12 items-center justify-center rounded-full bg-lightning-100 ring ring-lightning-500">
                    {feature.icon && (
                      <feature.icon
                ...
                <dd className="mt-2 ml-16 text-justify text-base text-gray-700">
                  {feature.description}
                </dd>
              </div>
            ))}
