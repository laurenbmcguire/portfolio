  ...
  return (
    <form onSubmit={handleSubmit}>
      <input
        ...
        id="email"
        required
        className="mr-5 w-80 rounded-md border-gray-300 pl-4 focus:border-lightning-500 focus:outline-none focus:ring-lightning-500 sm:text-base"
      ...
      <div className="mt-4 inline-flex rounded-md shadow sm:mt-0">
        <button
          type="submit"
          onClick={handleSubmit}
          className="inline-flex items-center justify-center rounded-md border border-transparent bg-lightning-600 px-5 py-2 text-base font-medium text-white hover:bg-lightning-700"
        >
          Register
        </button>
      </div>
    ...
    <div className="bg-white">
      <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-16 lg:px-8">
        <h2 className="text-center text-3xl font-extrabold tracking-tight text-gray-900 sm:text-left sm:text-4xl ">
          <span className="block">Want to hear about our latest features and recieve exclusive tips?</span>
