...
function StateExplanation() {
  return (
    <NavigationContainer>
      <MainLayout>
        ...
        <PageDescriptionParagraph>
          This capstone is set up to use Zustand.js for state management. It
          is designed to be simple to use, super lightweight (1.5 KB), and easy to learn so in my final deploy it will be utilized.
        </PageDescriptionParagraph>
        <PageDescriptionParagraph>
        ...
        <div className="mt-4 space-y-4">
          <p className="font-bold text-gray-900">How do I plan to use it?</p>
          <div className="space-y-4 pl-4">
            <p className="text-gray-700">
              You will find a store (that is where the state lives) in the file
    ...
    `}
            ...
            <p className="text-gray-700">
              Inside any component, you can import the state and have
              access to all state variables and functions.
              The component renders only when one of the picked state
              variables changes!
            </p>
            <div className="rounded-2xl bg-gray-100 px-2">
              <pre className="overflow-auto text-sm sm:text-base">
        ...
        <div className="mt-4">
          ...
          <ul role="list" className="mt-4 ml-4 list-disc space-y-2 pl-4">
            {[
              ...
              "Doesn't wrap the app in context providers",
