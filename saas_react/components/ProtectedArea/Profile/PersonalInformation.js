              ...
              <div className="overflow-hidden rounded-md shadow">
                    ...
                    <div className="col-span-6">
                      ...
                      <input
                        ...
                        className={classNames(
                          "mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-lightning-500 focus:ring-lightning-500 sm:text-sm",
                ...
                <div className="bg-gray-50 px-4 py-3 text-right sm:px-6">
                  <button
                    type="submit"
                    disabled={loading}
                    className="inline-flex w-24 justify-center rounded-md border border-transparent bg-lightning-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-lightning-700 focus:outline-none focus:ring-2 focus:ring-lightning-500 focus:ring-offset-2"
                  >
                    {loading ? (
